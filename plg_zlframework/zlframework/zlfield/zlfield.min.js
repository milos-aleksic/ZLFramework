...
events:{show:function(b,c){"checked"==a.attr("checked")&&b.preventDefault();a.bind("change",function(){c.hide()});c.set("content.text",a.parent().attr("tooltip"))}}})}),c.find(".zl-toggle").each(function(){var a=b(this),c=a.next();b(".btn-open",a).on("click",function(){a.toggleClass("open")&&c.show()});b(".btn-close",a).on("click",function(){a.toggleClass("open")&&c.hide()})}),c.find("[data-dependents]").each(function(){var a=b(this),c=a.data("dependents").replace(/ /g,"").split("|"),f=a.closest(".zlfield.placeholder .wrapper, .zlfield.placeholder").first();
c.each(function(c){var g=c.split("!>"),j=2==g.length?"!>":">",g=">"==j?c.split(">"):g;d=g[0].split(",");e=g[1].replace("NONE","");("select"==a.data("type")||"itemLayoutList"==a.data("type")||"layout"==a.data("type")||"apps"==a.data("type")||"types"==a.data("type")||"elements"==a.data("type")||"modulelist"==a.data("type")||"separatedby"==a.data("type"))&&d.each(function(c){var g=f.find('[data-id="'+c+'"]').data("e",e).data("m",j).hide();a.find(".zl-field select").bind("change",function(){var a=g.data("e"),
c=g.data("m"),f=b.makeArray(b(this).val()),j=0;a&&a.match(/OR/g)?b.each(f,function(b,g){var f=RegExp(g,"g");("!>"==c&&!a.match(f)||">"==c&&a.match(f))&&(j=1)}):(a&&a.match(/AND/g),b.each(f,function(b,f){("!>"==c&&f!=a||">"==c&&f==a)&&(j=1)}));j&&g.slideDown("fast")||g.slideUp("fast")}).trigger("change")});"checkbox"==a.data("type")&&d.each(function(c){var g=f.find('[data-id="'+c+'"]').hide();a.find(".zl-field input").bind("change",function(){var a="checked"==b(this).attr("checked");("!>"==j&&!a||
">"==j&&a)&&g.slideDown("fast")||g.slideUp("fast")}).trigger("change")});"radio"==a.data("type")&&d.each(function(c){var g=e,h=f.find('[data-id="'+c+'"]').hide();a.find(".zl-field input").bind("change",function(){var a="checked"==b(this).attr("checked"),c=0,f=b(this).attr("value");a&&(g&&g.match(/OR/g)?(a=RegExp(f,"g"),("!>"==j&&!g.match(a)||">"==j&&g.match(a))&&(c=1)):("!>"==j&&f!=g&&a||">"==j&&(f==g&&a)&&a)&&(c=1),c&&h.slideDown("fast")||h.slideUp("fast"))}).trigger("change")});"text"==a.data("type")&&
d.each(function(c){var g=f.find('[data-id="'+c+'"]').hide();a.find(".zl-field input").on("keyup change",function(){var a=""!=b(this).val();("!>"==j&&!a||">"==j&&a)&&g.slideDown("fast")||g.slideUp("fast")}).trigger("change")})})}),c.find("[data-relieson]").each(function(){var a=b(this),c=a.data("relieson"),h=a.parents(".placeholder").find('[data-id="'+c.id+'"]').find("select");h.on("change",function(){var m=b(this).val()?b(this).val():"",k=b(this).closest(".zl-field"),j=c.json,n=a.attr("data-control"),
p=b(this).closest(".zlfield-main").attr("data-ajaxargs"),l=c.psv,q=c.id;l[c.id]=m;k.append(b('<span class="activity zl-loader">'));b.getJSON(c.url,{task:"loadfield",json:j,ctrl:n,psv:l,pid:q,node:null,args:p,ajaxcall:!0,enviroment:f.options.enviroment},function(b){k.find(".activity").remove();a.slideUp("fast",function(){a.empty();b&&b.result&&a.html('<div class="loaded-fields">'+b.result+"</div>");f.actions(a.find("> .loaded-fields"));a.slideDown("fast");h.trigger("loaded.zlfield")})})})}),c.find(".load-field-btn").on("click",
function(a){a.preventDefault();a=b(this);var c=a.parent(".zlfield-main"),h=c.data("ajaxargs");a.find("span").addClass("zlux-loader-raw");b.ajax({url:f.options.url,type:"POST",data:{task:"loadZLfield",group:h.group,type:f.options.type,control_name:h.control_name,json_path:h.json_path,element_id:h.element_id,element_type:h.element_type,enviroment:h.enviroment,node:h.node},success:function(a){a=b.parseJSON(a);c.fadeOut("fast",function(){b(this).html(a.result);f.actions(c);c.fadeIn("slow")})}})}),c.data("zlfield-actions-init",
!0))}});b.fn[h.prototype.name]=function(){var c=arguments,f=c[0]?c[0]:null;return this.each(function(){var a=b(this);if(h.prototype[f]&&a.data(h.prototype.name)&&"initialize"!=f)a.data(h.prototype.name)[f].apply(a.data(h.prototype.name),Array.prototype.slice.call(c,1));else if(!f||b.isPlainObject(f)){var g=new h;h.prototype.initialize&&g.initialize.apply(g,b.merge([a],c));a.data(h.prototype.name,g)}else b.error("Method "+f+" does not exist on jQuery."+h.name)})}})(jQuery);