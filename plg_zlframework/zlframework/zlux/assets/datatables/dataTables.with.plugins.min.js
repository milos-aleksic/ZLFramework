...
(function(b){jQuery.fn.dataTableExt.oApi.fnGetColumnData=function(a,b,c,e,d){if("undefined"==typeof b)return[];"undefined"==typeof c&&(c=!0);"undefined"==typeof e&&(e=!0);"undefined"==typeof d&&(d=!0);a=!0==e?a.aiDisplay:a.aiDisplayMaster;e=[];for(var g=0,h=a.length;g<h;g++){iRow=a[g];var j=this.fnGetData(iRow,b);!0==d&&0==j.length||!0==c&&-1<jQuery.inArray(j,e)||e.push(j)}return e};b.fn.dataTableExt.oApi.fnReloadAjax=function(a,b,c,e){"undefined"!=typeof b&&null!=b&&(a.sAjaxSource=b);if(a.oFeatures.bServerSide)this.fnDraw(); else{this.oApi._fnProcessingDisplay(a,!0);var d=this,g=a._iDisplayStart;b=[];this.oApi._fnServerParams(a,b);a.fnServerData.call(a.oInstance,a.sAjaxSource,b,function(b){d.oApi._fnClearTable(a);b=""!==a.sAjaxDataProp?d.oApi._fnGetObjectDataFn(a.sAjaxDataProp)(b):b;for(var f=0;f<b.length;f++)d.oApi._fnAddData(a,b[f]);a.aiDisplay=a.aiDisplayMaster.slice();"undefined"!=typeof e&&!0===e?(a._iDisplayStart=g,d.fnDraw(!1)):d.fnDraw();d.oApi._fnProcessingDisplay(a,!1);"function"==typeof c&&null!=c&&c(a)},a)}}; b.fn.dataTableExt.aoFeatures.push({fnInit:function(a){return new m(a)},cFeature:"B",sFeature:"Breadcrumb"});var m=function(a){a.aoDrawCallback.push({fn:function(){var f=b(a.nTableWrapper).find(".breadcrumb"),c=a.sCurrentPath?a.sCurrentPath:"",e=[],d,c=c.replace(RegExp("^"+a.oInit.sStartRoot),""),c=c.replace(/(^\/|\/$)/,"");d=c.length?c.split("/"):[];d.length?e.push('<li><a href="#" data-path="">root</a><span class="divider">/</span></li>'):e.push('<li class="active">root</li>');c=[];b.each(d,function(a, b){c.push(b);d.length==a+1?e.push('<li class="active">'+b+"</li>"):e.push('<li><a href="#" data-path="'+c.join("/")+'">'+b+'</a><span class="divider">/</span></li>')});f.html(e.join(""))},sName:"Breadcrumb"});return b('<ul class="breadcrumb" />').on("click","a",function(){var f=a.sAjaxSource;a.sCurrentPath=a.oInit.sStartRoot;a.sGoToPath=b(this).data("path");a.oInstance.fnReloadAjax(f);return!1}).get(0)};b.extend(!0,b.fn.dataTable.defaults,{sDom:"<'row-fluid'<'span6'l><'span6'f>r>t<'row-fluid'<'span6'i><'span6'p>>", sPaginationType:"bootstrap",oLanguage:{sProcessing:'<span class="zlux-loader-circle-big"></span>',sLengthMenu:"_MENU_ records per page"},bProcessing:!1,bLengthChange:!1});b.extend(b.fn.dataTableExt.oStdClasses,{sWrapper:"dataTables_wrapper form-horizontal zlux-datatables"});b.fn.dataTableExt.oApi.fnPagingInfo=function(a){return{iStart:a._iDisplayStart,iEnd:a.fnDisplayEnd(),iLength:a._iDisplayLength,iTotal:a.fnRecordsTotal(),iFilteredTotal:a.fnRecordsDisplay(),iPage:-1===a._iDisplayLength?0:Math.ceil(a._iDisplayStart/ a._iDisplayLength),iTotalPages:-1===a._iDisplayLength?0:Math.ceil(a.fnRecordsDisplay()/a._iDisplayLength)}};var n=function(a){a.aoDrawCallback.push({fn:function(){for(var b=1<a.oInstance.fnPagingInfo().iTotalPages,c=0,e=a.aanFeatures.p.length;c<e;c++)a.aanFeatures.p[c].style.display=b?"block":"none"},sName:"PagingControl"})};b.fn.dataTableExt.aoFeatures.push({fnInit:function(a){new n(a)},cFeature:"P",sFeature:"PagingControl"});b.extend(b.fn.dataTableExt.oPagination,{bootstrap:{fnInit:function(a,f, c){var e=a.oLanguage.oPaginate,d=function(b){b.preventDefault();a.oApi._fnPageChange(a,b.data.action)&&c(a)};b(f).addClass("pagination").append('<ul><li class="prev disabled"><a class="prev" href="#">&larr; '+e.sPrevious+'</a></li><li class="next disabled"><a class="next" href="#">'+e.sNext+" &rarr; </a></li></ul>");f=b("a",f);b(f[0]).bind("click.DT",{action:"previous"},d);b(f[1]).bind("click.DT",{action:"next"},d)},fnUpdate:function(a,f){var c=a.oInstance.fnPagingInfo(),e=a.aanFeatures.p,d,g,h,j, k,l;d=Math.floor(2.5);5>c.iTotalPages?(k=1,l=c.iTotalPages):c.iPage<=d?(k=1,l=5):c.iPage>=c.iTotalPages-d?(k=c.iTotalPages-5+1,l=c.iTotalPages):(k=c.iPage-d+1,l=k+5-1);d=0;for(g=e.length;d<g;d++){b("li:gt(0)",e[d]).filter(":not(:last)").remove();for(h=k;h<=l;h++)j=h==c.iPage+1?'class="active"':"",b("<li "+j+'><a href="#">'+h+"</a></li>").insertBefore(b("li:last",e[d])[0]).bind("click",function(d){d.preventDefault();a._iDisplayStart=(parseInt(b("a",this).text(),10)-1)*c.iLength;f(a)});0===c.iPage? b("li:first",e[d]).addClass("disabled"):b("li:first",e[d]).removeClass("disabled");c.iPage===c.iTotalPages-1||0===c.iTotalPages?b("li:last",e[d]).addClass("disabled"):b("li:last",e[d]).removeClass("disabled")}}}})})(jQuery);