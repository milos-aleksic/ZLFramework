...
/* ZLUX Related */
(function(b){jQuery.fn.dataTableExt.oApi.fnGetColumnData=function(a,b,c,d,e){if("undefined"==typeof b)return[];"undefined"==typeof c&&(c=!0);"undefined"==typeof d&&(d=!0);"undefined"==typeof e&&(e=!0);a=!0==d?a.aiDisplay:a.aiDisplayMaster;d=[];for(var f=0,h=a.length;f<h;f++){iRow=a[f];var j=this.fnGetData(iRow,b);!0==e&&0==j.length||!0==c&&-1<jQuery.inArray(j,d)||d.push(j)}return d};b.fn.dataTableExt.oApi.fnReloadAjax=function(a,b,c,d){"undefined"!=typeof b&&null!=b&&(a.sAjaxSource=b);if(a.oFeatures.bServerSide)this.fnDraw(); else{this.oApi._fnProcessingDisplay(a,!0);var e=this,f=a._iDisplayStart;b=[];this.oApi._fnServerParams(a,b);a.fnServerData.call(a.oInstance,a.sAjaxSource,b,function(b){e.oApi._fnClearTable(a);b=""!==a.sAjaxDataProp?e.oApi._fnGetObjectDataFn(a.sAjaxDataProp)(b):b;for(var g=0;g<b.length;g++)e.oApi._fnAddData(a,b[g]);a.aiDisplay=a.aiDisplayMaster.slice();"undefined"!=typeof d&&!0===d?(a._iDisplayStart=f,e.fnDraw(!1)):e.fnDraw();e.oApi._fnProcessingDisplay(a,!1);"function"==typeof c&&null!=c&&c(a)},a)}}; b.fn.dataTableExt.aoFeatures.push({fnInit:function(a){return new m(a)},cFeature:"B",sFeature:"Breadcrumb"});var m=function(a){a.aoDrawCallback.push({fn:function(){var g=b(a.nTableWrapper).find(".breadcrumb"),c=a.oInit.sStartRoot,d="",e=RegExp("^"+c),f=a.sCurrentRoot,h=(f=f?f.replace(e,"").replace(/^\//,"").replace(/\/$/,""):!1)?f.split("/"):[],c=c.split("/").pop(),d=h.length?d+('<li><a href="#" data-path="">'+c+'</a><span class="divider">/</span></li>'):d+('<li class="active">'+c+"</li>"),f=[];b.each(h, function(a,b){f.push(b);d=h.length==a+1?d+('<li class="active">'+b+"</li>"):d+('<li><a href="#" data-path="'+f.join("/")+'">'+b+'</a><span class="divider">/</span></li>')});g.html(d)},sName:"Breadcrumb"});return b('<ul class="breadcrumb" />').on("click","a",function(){var g=a.sAjaxSource.replace(/\&root=.+/,"");a.oInstance.fnReloadAjax(g+"&root="+a.oInit.sStartRoot+"/"+b(this).data("path"));return!1}).get(0)};b.extend(!0,b.fn.dataTable.defaults,{sDom:"<'row-fluid'<'span6'l><'span6'f>r>t<'row-fluid'<'span6'i><'span6'p>>", sPaginationType:"bootstrap",oLanguage:{sProcessing:'<span class="zlux-loader-circle-big"></span>',sLengthMenu:"_MENU_ records per page"},bProcessing:!1,bLengthChange:!1});b.extend(b.fn.dataTableExt.oStdClasses,{sWrapper:"dataTables_wrapper form-horizontal zlux-datatables"});b.fn.dataTableExt.oApi.fnPagingInfo=function(a){return{iStart:a._iDisplayStart,iEnd:a.fnDisplayEnd(),iLength:a._iDisplayLength,iTotal:a.fnRecordsTotal(),iFilteredTotal:a.fnRecordsDisplay(),iPage:-1===a._iDisplayLength?0:Math.ceil(a._iDisplayStart/ a._iDisplayLength),iTotalPages:-1===a._iDisplayLength?0:Math.ceil(a.fnRecordsDisplay()/a._iDisplayLength)}};var n=function(a){a.aoDrawCallback.push({fn:function(){for(var b=1<a.oInstance.fnPagingInfo().iTotalPages,c=0,d=a.aanFeatures.p.length;c<d;c++)a.aanFeatures.p[c].style.display=b?"block":"none"},sName:"PagingControl"})};b.fn.dataTableExt.aoFeatures.push({fnInit:function(a){new n(a)},cFeature:"P",sFeature:"PagingControl"});b.extend(b.fn.dataTableExt.oPagination,{bootstrap:{fnInit:function(a,g, c){var d=a.oLanguage.oPaginate,e=function(b){b.preventDefault();a.oApi._fnPageChange(a,b.data.action)&&c(a)};b(g).addClass("pagination").append('<ul><li class="prev disabled"><a class="prev" href="#">&larr; '+d.sPrevious+'</a></li><li class="next disabled"><a class="next" href="#">'+d.sNext+" &rarr; </a></li></ul>");g=b("a",g);b(g[0]).bind("click.DT",{action:"previous"},e);b(g[1]).bind("click.DT",{action:"next"},e)},fnUpdate:function(a,g){var c=a.oInstance.fnPagingInfo(),d=a.aanFeatures.p,e,f,h,j, k,l;e=Math.floor(2.5);5>c.iTotalPages?(k=1,l=c.iTotalPages):c.iPage<=e?(k=1,l=5):c.iPage>=c.iTotalPages-e?(k=c.iTotalPages-5+1,l=c.iTotalPages):(k=c.iPage-e+1,l=k+5-1);e=0;for(f=d.length;e<f;e++){b("li:gt(0)",d[e]).filter(":not(:last)").remove();for(h=k;h<=l;h++)j=h==c.iPage+1?'class="active"':"",b("<li "+j+'><a href="#">'+h+"</a></li>").insertBefore(b("li:last",d[e])[0]).bind("click",function(d){d.preventDefault();a._iDisplayStart=(parseInt(b("a",this).text(),10)-1)*c.iLength;g(a)});0===c.iPage? b("li:first",d[e]).addClass("disabled"):b("li:first",d[e]).removeClass("disabled");c.iPage===c.iTotalPages-1||0===c.iTotalPages?b("li:last",d[e]).addClass("disabled"):b("li:last",d[e]).removeClass("disabled")}}}})})(jQuery);