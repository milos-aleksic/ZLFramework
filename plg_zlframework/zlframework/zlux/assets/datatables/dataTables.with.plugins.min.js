...
(function(b){jQuery.fn.dataTableExt.oApi.fnGetColumnData=function(a,b,e,c,d){if("undefined"==typeof b)return[];"undefined"==typeof e&&(e=!0);"undefined"==typeof c&&(c=!0);"undefined"==typeof d&&(d=!0);a=!0==c?a.aiDisplay:a.aiDisplayMaster;c=[];for(var g=0,h=a.length;g<h;g++){iRow=a[g];var k=this.fnGetData(iRow,b);if(!0!=d||0!=k.length)!0==e&&-1<jQuery.inArray(k,c)||c.push(k)}return c};b.fn.dataTableExt.oApi.fnReloadAjax=function(a,b,e,c){"undefined"!=typeof b&&null!=b&&(a.sAjaxSource=b);if(a.oFeatures.bServerSide)this.fnDraw(); else{this.oApi._fnProcessingDisplay(a,!0);var d=this,g=a._iDisplayStart;b=[];this.oApi._fnServerParams(a,b);a.fnServerData.call(a.oInstance,a.sAjaxSource,b,function(b){d.oApi._fnClearTable(a);b=""!==a.sAjaxDataProp?d.oApi._fnGetObjectDataFn(a.sAjaxDataProp)(b):b;for(var f=0;f<b.length;f++)d.oApi._fnAddData(a,b[f]);a.aiDisplay=a.aiDisplayMaster.slice();"undefined"!=typeof c&&!0===c?(a._iDisplayStart=g,d.fnDraw(!1)):d.fnDraw();d.oApi._fnProcessingDisplay(a,!1);"function"==typeof e&&null!=e&&e(a)},a)}}; b.fn.dataTableExt.aoFeatures.push({fnInit:function(a){return new p(a)},cFeature:"B",sFeature:"Breadcrumb"});var p=function(a){a.aoDrawCallback.push({fn:function(){var f=b(a.nTableWrapper).find(".breadcrumb"),e=a.oInit.sStartRoot,c=a.sCurrentPath?a.sCurrentPath:"",d=[],g,h=b.fn.zluxMain.prototype.translate("ROOT").toLowerCase(),c=c.replace(RegExp("^"+e),""),c=c.replace(/(^\/|\/$)/,"");g=c.length?c.split("/"):[];g.length?d.push('<li><a href="#" data-path="">'+h+'</a><span class="divider">/</span></li>'): d.push('<li class="active">'+h+"</li>");c=[];b.each(g,function(a,b){c.push(b);g.length==a+1?d.push('<li class="active">'+b+"</li>"):d.push('<li><a href="#" data-path="'+c.join("/")+'">'+b+'</a><span class="divider">/</span></li>')});f.html(d.join(""))},sName:"Breadcrumb"});return b('<ul class="breadcrumb" />').on("click","a",function(f){f=a.sAjaxSource;a.sCurrentPath=a.oInit.sStartRoot;a.sGoToPath=b(this).data("path");a.oInstance.fnReloadAjax(f);return!1}).get(0)};b.fn.dataTableExt.aoFeatures.push({fnInit:function(a){return new q(a)}, cFeature:"F",sFeature:"Filtering"});var q=function(a){var f=b('<div class="zlux-x-filter-input_wrapper" />'),e=null;b('<input type="text" class="zlux-x-filter-input" />').on("keyup",function(c){var d=b(this).val();clearTimeout(e);""==d&&n(a,"");13==(c.keyCode?c.keyCode:c.which)&&n(a,d);e=setTimeout(function(){n(a,d)},500)}).appendTo(f);return f[0]},n=function(a,b){b!=a.oPreviousSearch.sSearch&&a.oInstance.fnFilter(b)};b.extend(!0,b.fn.dataTable.defaults,{sDom:"<'row-fluid'<'span6'l><'span6'f>r>t<'row-fluid'<'span6'i><'span6'p>>", sPaginationType:"bootstrap",oLanguage:{sProcessing:'<span class="zlux-loader-circle-big"></span>',sLengthMenu:"_MENU_ records per page"},bProcessing:!1,bLengthChange:!1});b.extend(b.fn.dataTableExt.oStdClasses,{sWrapper:"dataTables_wrapper form-horizontal zlux-datatables",sStripeOdd:"",sStripeEven:""});b.fn.dataTableExt.oApi.fnPagingInfo=function(a){return{iStart:a._iDisplayStart,iEnd:a.fnDisplayEnd(),iLength:a._iDisplayLength,iTotal:a.fnRecordsTotal(),iFilteredTotal:a.fnRecordsDisplay(),iPage:-1=== a._iDisplayLength?0:Math.ceil(a._iDisplayStart/a._iDisplayLength),iTotalPages:-1===a._iDisplayLength?0:Math.ceil(a.fnRecordsDisplay()/a._iDisplayLength)}};var r=function(a){a.aoDrawCallback.push({fn:function(){for(var b=1<a.oInstance.fnPagingInfo().iTotalPages,e=0,c=a.aanFeatures.p.length;e<c;e++)a.aanFeatures.p[e].style.display=b?"block":"none"},sName:"PagingControl"})};b.fn.dataTableExt.aoFeatures.push({fnInit:function(a){new r(a)},cFeature:"P",sFeature:"PagingControl"});b.extend(b.fn.dataTableExt.oPagination, {bootstrap:{fnInit:function(a,f,e){var c=function(b){b.preventDefault();a.oApi._fnPageChange(a,b.data.action)&&e(a)};b(f).addClass("pagination").append('<ul class="zlux-x-pagination"><li class="first disabled"><a href="#" class="zlux-x-btn"><i class="icon-double-angle-left"></i></a></li><li class="prev disabled"><a href="#" class="zlux-x-btn"><i class="icon-angle-left"></i></a></li><li class="next disabled"><a href="#" class="zlux-x-btn"><i class="icon-angle-right"></i></a></li><li class="last disabled"><a href="#" class="zlux-x-btn"><i class="icon-double-angle-right"></i></a></li></ul>'); f=b("a",f);b(f[0]).bind("click.DT",{action:"first"},c);b(f[1]).bind("click.DT",{action:"previous"},c);b(f[2]).bind("click.DT",{action:"next"},c);b(f[3]).bind("click.DT",{action:"last"},c)},fnUpdate:function(a,f){var e=a.oInstance.fnPagingInfo(),c=a.aanFeatures.p,d,g,h,k,l,m;d=Math.floor(2);4>e.iTotalPages?(l=1,m=e.iTotalPages):e.iPage<=d?(l=1,m=4):e.iPage>=e.iTotalPages-d?(l=e.iTotalPages-4+1,m=e.iTotalPages):(l=e.iPage-d+1,m=l+4-1);d=0;for(g=c.length;d<g;d++){b("li:gt(1)",c[d]).filter(":not(:last)").not(".next").remove(); for(h=l;h<=m;h++)k=h==e.iPage+1?'class="active"':"",b("<li "+k+'><a href="#">'+h+"</a></li>").insertBefore(b("li.next, li.last",c[d])[0]).bind("click",function(c){c.preventDefault();a._iDisplayStart=(parseInt(b("a",this).text(),10)-1)*e.iLength;f(a)});0===e.iPage?b("li.first, li.prev",c[d]).addClass("disabled"):b("li.first, li.prev",c[d]).removeClass("disabled");e.iPage===e.iTotalPages-1||0===e.iTotalPages?b("li.next, li.last",c[d]).addClass("disabled"):b("li.next, li.last",c[d]).removeClass("disabled")}}}})})(jQuery);