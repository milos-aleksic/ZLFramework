...
a).dataTable({sDom:"F<'row-fluid'<'span12'B>><'row-fluid'<'span12't>>",oLanguage:{sEmptyTable:"No files found",sInfoEmpty:""},sAjaxUrl:c.AjaxUrl,sAjaxSource:d,sServerMethod:"POST",sStartRoot:c.cleanPath(c.options.root),bPaginate:!1,aoColumns:[{sTitle:"",mData:"type",bSearchable:!1,sWidth:"14px",sClass:"column-icon",mRender:function(a,b){return"display"==b?'<i class="icon-'+("folder"==a?"folder-close":"file-alt")+'"></i>':a}},{sTitle:"Name",mData:"name",sClass:"column-name",mRender:function(a,b){return"display"==
...
(d=c?'<div class="zlux-x-image"><img src="'+a.path+'" /></div>':'<span class="zlux-x-filetype">'+a.ext+"</span>",a.size&&e.push({name:"size",value:a.size.display}));var f="";b.each(e,function(a,b){f+="<li>"+b.value+"</li>"});return b('<div class="zlux-preview"><div class="zlux-x-thumbnail">'+d+'</div><ul class="zlux-x-details unstyled">'+f+"</ul></div>")}});b.fn[f.prototype.name]=function(){var a=arguments,b=new f;if(f.prototype.initialize)return b.initialize.apply(b,a)}})(jQuery);
