 ...
 * ========================================================== */
(function(b){var a=function(c){this.options=b.extend({},this.options,c);this.events={}};a.prototype=b.extend(a.prototype,{name:"zluxMain",options:{},events:{},JRoot:"",AjaxUrl:"administrator/index.php?option=com_zoo&controller=zlux&format=raw",createCache:function(c){var a={};return function(e,d){a[e]||(a[e]=b.Deferred(function(a){c(a,e)}).promise());return a[e].done(d)}},trigger:function(c){var a=this.events[c.toLowerCase()],e,b;if(a){b=Array.prototype.slice.call(arguments);b[0]=this;for(e=0;e<a.length;e++)if(!1=== a[e].func.apply(a[e].scope,b))return!1}return!0},bind:function(c,a,b){var d;c=c.toLowerCase();d=this.events[c]||[];d.push({func:a,scope:b||this});this.events[c]=d;return this},unbind:function(a,b){a=a.toLowerCase();var e=this.events[a],d;if(e){if(b!==undef)for(d=e.length-1;0<=d;d--){if(e[d].func===b){e.splice(d,1);break}}else e=[];e.length||delete this.events[a]}},unbindAll:function(){var a=this;plupload.each(events,function(b,d){a.unbind(d)})},hasEventListener:function(a){return!!this.events[a.toLowerCase()]}, sprintf:function(a){var b=[].slice.call(arguments,1),d="";a.split(/%[sdf]/).forEach(function(a){d+=a;b.length&&(d+=b.shift())});return d},_ErrorLog:function(a,b){var d=void 0===this.ID?this.name+": "+b:this.name+" warning (id = '"+this.ID+"'): "+b;0===a?alert(d):window.console&&console.log&&console.log(d)}});b.fn[a.prototype.name]=a;if(location.href.match(/^(.+)administrator\/index\.php.*/i)){var d=location.href.match(/^(.+)administrator\/index\.php.*/i)[1];b.fn[a.prototype.name].prototype.JRoot= d;b.fn[a.prototype.name].prototype.AjaxUrl=d+"administrator/index.php?option=com_zoo&controller=zlux&format=raw"}})(jQuery); (function(b){var a=function(a){this.options=b.extend({},this.options,a);this.events={}};a.prototype=b.extend(a.prototype,b.fn.zluxMain.prototype,{name:"zluxManager",options:{},events:{},initialize:function(a,c){this.options=b.extend({},this.options,c)},reload:function(){var a=this.oTable.fnSettings();a.bReloading=!0;this.oTable.fnReloadAjax(a.sAjaxSource)},pushMessageToObject:function(a,c){"string"==typeof c?c=b("<div>"+c+"</div>"):1<c.length&&b.each(c,function(a,d){c[a]=b("<div>"+d+"</div>")});var f= b(".zlux-x-msg",a.dom),e=b('<div class="zlux-x-details-content zlux-x-msg" />').hide().append(c,b('<i class="zlux-x-msg-remove icon-remove" />').on("click",function(){e.fadeOut()})).prependTo(b(".zlux-x-details",a.dom)).slideDown("fast",function(){f.fadeOut("slow",function(){b(this).remove()})});return e},pushStorageData:function(a){"s3"==this.options.storage&&(a.push({name:"storage",value:"s3"}),a.push({name:"accesskey",value:this.options.storage_params.accesskey}),a.push({name:"key",value:this.options.storage_params.secretkey}), a.push({name:"bucket",value:this.options.storage_params.bucket}));return a}});b.fn[a.prototype.name]=function(){if(!this.data(a.prototype.name)){var d=arguments,c=d[0]?d[0]:null;return this.each(function(){var f=b(this);if(a.prototype[c]&&f.data(a.prototype.name)&&"initialize"!=c)f.data(a.prototype.name)[c].apply(f.data(a.prototype.name),Array.prototype.slice.call(d,1));else if(!c||b.isPlainObject(c)){var e=new a;a.prototype.initialize&&e.initialize.apply(e,b.merge([f],d));f.data(a.prototype.name, e)}else b.error("Method "+c+" does not exist on jQuery."+a.name)})}};b.fn[a.prototype.name]=a})(jQuery); (function(b){var a=function(){};a.prototype=b.extend(a.prototype,{name:"zluxSaveElement",options:{msgSaveElement:"Save Element",item_id:0,elm_id:""},initialize:function(a,c){this.options=b.extend({},this.options,c);var f=this;b('<a class="btn btn-small save" href="javascript:void(0);" />').append('<i class="icon-ok-sign"></i> '+f.options.msgSaveElement).on("click",function(){var a=b(this).addClass("btn-working"),c=a.closest(".element").find("input, textarea").serializeArray();b.post(f.AjaxUrl+"&task=saveelement&item_id="+ f.options.item_id+"&elm_id="+f.options.elm_id,c,function(){a.removeClass("btn-working")})}).appendTo(a.find(".btn-toolbar"))}});b.fn[a.prototype.name]=function(){var d=arguments,c=d[0]?d[0]:null;return this.each(function(){var f=b(this);if(a.prototype[c]&&f.data(a.prototype.name)&&"initialize"!=c)f.data(a.prototype.name)[c].apply(f.data(a.prototype.name),Array.prototype.slice.call(d,1));else if(!c||b.isPlainObject(c)){var e=new a;a.prototype.initialize&&e.initialize.apply(e,b.merge([f],d));f.data(a.prototype.name, e)}else b.error("Method "+c+" does not exist on jQuery."+a.name)})}})(jQuery); (function(b){var a=function(a){this.options=b.extend({},this.options,a);this.events={}};a.prototype=b.extend(a.prototype,b.fn.zluxMain.prototype,{name:"zluxExample",options:{param:""},events:{},initialize:function(a,c){this.options=b.extend({},b.fn.zluxMain.prototype.options,this.options,c)},some_function:function(){}});b.fn[a.prototype.name]=function(){var d=arguments,c=d[0]?d[0]:null;return this.each(function(){var f=b(this);if(a.prototype[c]&&f.data(a.prototype.name)&&"initialize"!=c)f.data(a.prototype.name)[c].apply(f.data(a.prototype.name), Array.prototype.slice.call(d,1));else if(!c||b.isPlainObject(c)){var e=new a;a.prototype.initialize&&e.initialize.apply(e,b.merge([f],d));f.data(a.prototype.name,e)}else b.error("Method "+c+" does not exist on jQuery."+a.name)})}})(jQuery);
