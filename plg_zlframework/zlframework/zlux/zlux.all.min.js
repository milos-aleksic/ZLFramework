...
sInfo:"_END_ of _TOTAL_"},aoColumns:[{sTitle:"Name",mData:"_itemname",sClass:"column-name",mRender:function(a,b){return"display"==b?"":a},fnCreatedCell:function(a,b,d){c(a).parent("tr").attr("data-id",d.id)}},{sTitle:"App",mData:"application",bSortable:!1,mRender:function(a,b){return"display"==b?a.name:a.id}},{sTitle:"Type",mData:"type",bSortable:!1,mRender:function(a,b){return"display"==b?a.name:a.id}},{sTitle:"Access",mData:"access",bSearchable:!1,bSortable:!1},{sTitle:"Author",mData:"author",bSearchable:!1,
bSortable:!1,mRender:function(a,b){return"display"==b?a.name:a.id}},{sTitle:"ID",mData:"id",bSearchable:!1,bSortable:!1},{sTitle:"",mData:"type",bSortable:!1,bSearchable:!1,sWidth:"14px",sClass:"column-icon",mRender:function(a,b){return"display"==b?'<i class="icon-file-alt"></i>':a}}],aoColumnDefs:[{bVisible:!1,aTargets:[1,2,3,4,5]}],fnInitComplete:function(){var e=c(".dataTables_filter",a).append(c('<i class="icon-search" />'),c('<i class="icon-remove zlux-ui-dropdown-unselect" />').hide().on("click",
function(){c("input",e).val("");c(this).hide();b.oTable.fnFilter("")}));c("label",e).addClass("zlux-x-label");c("input",e).on("keyup",function(){""==c(this).val()?c(".zlux-ui-dropdown-unselect",e).hide():c(".zlux-ui-dropdown-unselect",e).show()});c("thead tr th:last",b.oTable).prependTo(c("thead tr",b.oTable));b.trigger("InitComplete")},fnRowCallback:function(a,f){f.dom=c(a);f.dom.addClass("zlux-object");c("td:last",f.dom).prependTo(f.dom);c(".column-name",f.dom).html("").removeClass("zlux-ui-open").append(b.renderObjectDOM(f))},
fnPreDrawCallback:function(a){b.zluxdialog.spinner("show");b.trigger("DTPreDrawCallback",a)},fnDrawCallback:function(a){var f=a.oInstance.fnPagingInfo(),d=c(".dataTables_paginate",c(a.nTableWrapper)).closest(".row-fluid");1>=f.iTotalPages&&d.hide()||d.show();b.zluxdialog.scrollbar("refresh");b.zluxdialog.spinner("hide");b.trigger("TableDrawCallback",a)}}).on("click",".zlux-object .zlux-x-name a",function(){var a=c(this).closest("tr.zlux-object"),d=b.oTable.fnGetData(a[0]);d.dom=a;b.trigger("ObjectSelected",
d);return!1})},renderObjectDOM:function(a){var b;b=[{name:"Route",value:a.application.name+" / "+a.type.name+" / ID "+a.id},{name:"Access",value:a.access},{name:"Created",value:a.created}];a.author.name&&b.push({name:"Author",value:a.author.name});var e="";c.each(b,function(a,b){e+="<li><strong>"+b.name+"</strong>: <span>"+b.value+"</span></li>"});return c('<div class="zlux-x-tools"><i class="zlux-x-details-btn icon-angle-down" /></div><div class="zlux-x-name"><a href="#" class="zlux-x-name-link">'+
