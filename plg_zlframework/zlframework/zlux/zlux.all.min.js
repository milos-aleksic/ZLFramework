...
a.zluxdialog.toolbarBtnState(2,"add","disabled")}).bind("FileUploaded",function(b,d){c(".zlux-x-name",d.dom).html(d.name);c(".zlux-upload-file-progress",d.dom).html("100%").fadeOut();c(".zlux-x-object-icon",d.dom).removeClass("icon-file-alt").addClass("icon-ok");c(".zlux-x-name",d.dom).wrapInner('<a class="zlux-x-name-link" href="#" />').end().on("click","a",function(){var b=c('.zlux-object[data-id="'+d.name+'"]',a.filesmanager);d=a.oTable.fnGetData(b[0]);a.trigger("ObjectSelected",d);return!1})}).bind("FileNotUpload",
function(b,d,e){a.zluxdialog.toolbarBtnState(2,"cancel","disabled");a.zluxdialog.toolbarBtnState(2,"start","disabled");a.zluxdialog.toolbarBtnState(2,"add","enabled");c(".zlux-upload-file-progress",d.dom).fadeOut();c(".zlux-x-object-icon",d.dom).removeClass("icon-file-alt").addClass("icon-warning-sign");b=a.pushMessageToObject(d,e);c(".zlux-x-msg-remove",b).remove()}).bind("UploadComplete",function(b){a.zluxdialog.toolbarBtnState(2,"cancel","disabled");a.zluxdialog.toolbarBtnState(2,"start","disabled");
a.zluxdialog.toolbarBtnState(2,"add","enabled");a.reload()}).bind("CancelUpload",function(b){a.zluxdialog.toolbarBtnState(2,"cancel","disabled");a.zluxdialog.toolbarBtnState(2,"add","enabled")}).bind("QueueChanged",function(b,d){var e=!1;c.each(d,function(a,b){b.status!=plupload.DONE&&"validating"!=b.status&&(e=!0)});d.length?e?a.zluxdialog.toolbarBtnState(2,"start","enabled"):a.zluxdialog.toolbarBtnState(2,"start","disabled"):a.zluxdialog.toolbarBtnState(2,"start","disabled")}).bind("FileError",
