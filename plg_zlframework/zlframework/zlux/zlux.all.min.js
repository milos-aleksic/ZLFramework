...
b(this).closest(".zlux-object"),d=a.uploader.getFile(c[0].id);d&&("undefined"==d||d.zlux_status!=plupload.STARTED&&d.status!=plupload.UPLOADING)?(a.uploader.removeFile(d),c.remove()):(c.remove(),a._updateFilelist())}})},initPlupload:function(){var a=this,c;c={runtimes:"html5",browse_button:b(".zlux-upload-browse",a.upload)[0],drop_element:a.dropzone[0],max_file_size:void 0,url:a.AjaxURL()+"&task=upload",filters:[{title:"Files",extensions:this.options.extensions}],flash_swf_url:a.JRoot()+"plugins/system/zlframework/zlframework/zlux/assets/plupload/Moxie.swf"};
