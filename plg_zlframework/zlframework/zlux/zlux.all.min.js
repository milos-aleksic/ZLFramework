 ...
 * ========================================================== */
(function(a){var d=function(e){this.options=a.extend({},this.options,e);this.events={}};d.prototype=a.extend(d.prototype,{name:"zluxMain",options:{},events:{},JRoot:location.href.match(/^(.+)administrator\/index\.php.*/i)[1],AjaxUrl:location.href.match(/^(.+)administrator\/index\.php.*/i)[1]+"administrator/index.php?option=com_zoo&controller=zlux&format=raw",initialize:function(e,b){this.options=a.extend({},this.options,b)},createCache:function(e){var b={};return function(c,d){b[c]||(b[c]=a.Deferred(function(b){e(b, c)}).promise());return b[c].done(d)}},trigger:function(e){var b=this.events[e.toLowerCase()],c,a;if(b){a=Array.prototype.slice.call(arguments);a[0]=this;for(c=0;c<b.length;c++)if(!1===b[c].func.apply(b[c].scope,a))return!1}return!0},bind:function(e,b,c){var a;e=e.toLowerCase();a=this.events[e]||[];a.push({func:b,scope:c||this});this.events[e]=a;return this},unbind:function(e,b){e=e.toLowerCase();var c=this.events[e],a;if(c){if(b!==undef)for(a=c.length-1;0<=a;a--){if(c[a].func===b){c.splice(a,1);break}}else c= [];c.length||delete this.events[e]}},unbindAll:function(){var a=this;plupload.each(events,function(b,c){a.unbind(c)})},hasEventListener:function(a){return!!this.events[a.toLowerCase()]},sprintf:function(a){var b=[].slice.call(arguments,1),c="";a.split(/%[sdf]/).forEach(function(a){c+=a;b.length&&(c+=b.shift())});return c},_ErrorLog:function(a,b){var c=void 0===this.ID?this.name+": "+b:this.name+" warning (id = '"+this.ID+"'): "+b;0===a?alert(c):window.console&&console.log&&console.log(c)}});a.fn[d.prototype.name]= d})(jQuery); (function(a){var d=function(e){this.options=a.extend({},this.options,e);this.events={}};d.prototype=a.extend(d.prototype,a.fn.zluxMain.prototype,{name:"zluxManager",options:{},events:{},initialize:function(e,b){this.options=a.extend({},this.options,b)},reload:function(){var a=this.oTable.fnSettings();a.bReloading=!0;this.oTable.fnReloadAjax(a.sAjaxSource)},pushMessageToObject:function(e,b){"string"==typeof b?b=a("<div>"+b+"</div>"):1<b.length&&a.each(b,function(c,e){b[c]=a("<div>"+e+"</div>")});var c= a(".zlux-x-msg",e.dom),d=a('<div class="zlux-x-details-content zlux-x-msg" />').hide().append(b,a('<i class="zlux-x-msg-remove icon-remove" />').on("click",function(){d.fadeOut()})).prependTo(a(".zlux-x-details",e.dom)).slideDown("fast",function(){c.fadeOut("slow",function(){a(this).remove()})});return d},pushStorageData:function(a){"s3"==this.options.storage&&(a.push({name:"storage",value:"s3"}),a.push({name:"accesskey",value:this.options.storage_params.accesskey}),a.push({name:"key",value:this.options.storage_params.secretkey}), a.push({name:"bucket",value:this.options.storage_params.bucket}));return a}});a.fn[d.prototype.name]=function(){if(!this.data(d.prototype.name)){var e=arguments,b=e[0]?e[0]:null;return this.each(function(){var c=a(this);if(d.prototype[b]&&c.data(d.prototype.name)&&"initialize"!=b)c.data(d.prototype.name)[b].apply(c.data(d.prototype.name),Array.prototype.slice.call(e,1));else if(!b||a.isPlainObject(b)){var f=new d;d.prototype.initialize&&f.initialize.apply(f,a.merge([c],e));c.data(d.prototype.name, f)}else a.error("Method "+b+" does not exist on jQuery."+d.name)})}};a.fn[d.prototype.name]=d})(jQuery); (function(a){var d=function(){};d.prototype=a.extend(d.prototype,{name:"zluxSaveElement",options:{msgSaveElement:"Save Element",item_id:0,elm_id:""},initialize:function(d,b){this.options=a.extend({},this.options,b);var c=this;a('<a class="btn btn-small save" href="javascript:void(0);" />').append('<i class="icon-ok-sign"></i> '+c.options.msgSaveElement).on("click",function(){var b=a(this).addClass("btn-working"),d=b.closest(".element").find("input, textarea").serializeArray();a.post(c.AjaxUrl+"&task=saveelement&item_id="+ c.options.item_id+"&elm_id="+c.options.elm_id,d,function(){b.removeClass("btn-working")})}).appendTo(d.find(".btn-toolbar"))}});a.fn[d.prototype.name]=function(){var e=arguments,b=e[0]?e[0]:null;return this.each(function(){var c=a(this);if(d.prototype[b]&&c.data(d.prototype.name)&&"initialize"!=b)c.data(d.prototype.name)[b].apply(c.data(d.prototype.name),Array.prototype.slice.call(e,1));else if(!b||a.isPlainObject(b)){var f=new d;d.prototype.initialize&&f.initialize.apply(f,a.merge([c],e));c.data(d.prototype.name, f)}else a.error("Method "+b+" does not exist on jQuery."+d.name)})}})(jQuery); (function(a){var d=function(d){this.options=a.extend({},this.options,d);this.events={}};d.prototype=a.extend(d.prototype,a.fn.zluxMain.prototype,{name:"zluxExample",options:{param:""},events:{},initialize:function(d,b){this.options=a.extend({},a.fn.zluxMain.prototype.options,this.options,b)},some_function:function(){}});a.fn[d.prototype.name]=function(){var e=arguments,b=e[0]?e[0]:null;return this.each(function(){var c=a(this);if(d.prototype[b]&&c.data(d.prototype.name)&&"initialize"!=b)c.data(d.prototype.name)[b].apply(c.data(d.prototype.name), Array.prototype.slice.call(e,1));else if(!b||a.isPlainObject(b)){var f=new d;d.prototype.initialize&&f.initialize.apply(f,a.merge([c],e));c.data(d.prototype.name,f)}else a.error("Method "+b+" does not exist on jQuery."+d.name)})}})(jQuery);
...
function(){d.zluxdialog.toggle();return!1});d.initDialog();d.initMainEvents()},initDialog:function(){var a=this;a.zluxdialog=b.fn.zluxDialog({title:a.options.title,width:a.options.full_mode?"75%":300,dialogClass:"zl-bootstrap zlux-filesmanager "+(a.options.full_mode?"zlux-dialog-full":"zlux-dialog-mini"),position:!1==a.options.full_mode?{of:a.dialogTrigger,my:"left top",at:"right bottom"}:null}).done(function(){a.zluxdialog.widget.attr("id","zluxFilesManager_"+a.ID);a.eventDialogLoaded()})},eventDialogLoaded:function(){var a=
...
function(){a.zluxdialog.scrollbar("refresh");var c=b(".zlux-dialog-subtoolbar-filter",a.zluxdialog.toolbar.wrapper);b(".dataTables_filter",a.oTable.fnSettings().nTableWrapper).appendTo(c);a.zluxdialog.initContent()}).bind("BeforeDeleteFile",function(c,d){if(!b(".zlux-x-details-message-actions")[0]){var e=b('<div>You are about to delete this file, please <span class="label label-warning label-link">confirm</span></div>').on("click",".label-link",function(){b(this).data("submited")||(b(this).data("submited",
...
this.ID=c.fn.zluxItemsManager.iNextUnique},initDataTable:function(a){var b=this;c('<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" />').appendTo(a);b.oTable=c("table",a).dataTable({sDom:"f<'row-fluid'<'span12't>><'row-fluid'<'span12'p>><'row-fluid'<'span12'i>>",bServerSide:!0,iDisplayLength:20,sAjaxSource:b.AjaxUrl+"&task=ItemsManager",fnServerParams:function(a){var c=b.filter.apps?b.filter.apps:b.options.apps,d=b.filter.types?b.filter.types:b.options.types,
j=b.filter.cats?b.filter.cats:b.options.categories;tags=b.filter.tags?b.filter.tags:b.options.tags;a.push({name:"apps",value:b.options.apps});a.push({name:"types",value:b.options.types});a.push({name:"filter_apps",value:c});a.push({name:"filter_types",value:d});a.push({name:"filter_cats",value:j});a.push({name:"filter_tags",value:tags})},oLanguage:{sSearch:"_INPUT_",sEmptyTable:"No Items found",sInfoEmpty:"",sInfo:"_END_ of _TOTAL_"},aoColumns:[{sTitle:"Name",mData:"_itemname",sClass:"column-name",
mRender:function(a,b){return"display"==b?"":a},fnCreatedCell:function(a,b,d){c(a).parent("tr").attr("data-id",d.id)}},{sTitle:"App",mData:"application",bSortable:!1,mRender:function(a,b){return"display"==b?a.name:a.id}},{sTitle:"Type",mData:"type",bSortable:!1,mRender:function(a,b){return"display"==b?a.name:a.id}},{sTitle:"Access",mData:"access",bSearchable:!1,bSortable:!1},{sTitle:"Author",mData:"author",bSearchable:!1,bSortable:!1,mRender:function(a,b){return"display"==b?a.name:a.id}},{sTitle:"ID",
mData:"id",bSearchable:!1,bSortable:!1},{sTitle:"",mData:"type",bSortable:!1,bSearchable:!1,sWidth:"14px",sClass:"column-icon",mRender:function(a,b){return"display"==b?'<i class="icon-file-alt"></i>':a}}],aoColumnDefs:[{bVisible:!1,aTargets:[1,2,3,4,5]}],fnInitComplete:function(){var e=c(".dataTables_filter",a).append(c('<i class="icon-search" />'),c('<i class="icon-remove zlux-ui-dropdown-unselect" />').hide().on("click",function(){c("input",e).val("");c(this).hide();b.oTable.fnFilter("")}));c("label",
e).addClass("zlux-x-label");c("input",e).on("keyup",function(){""==c(this).val()?c(".zlux-ui-dropdown-unselect",e).hide():c(".zlux-ui-dropdown-unselect",e).show()});c("thead tr th:last",b.oTable).prependTo(c("thead tr",b.oTable));b.trigger("InitComplete")},fnRowCallback:function(a,f){f.dom=c(a);f.dom.addClass("zlux-object");c("td:last",f.dom).prependTo(f.dom);c(".column-name",f.dom).html("").removeClass("zlux-ui-open").append(b.renderObjectDOM(f))},fnPreDrawCallback:function(a){b.zluxdialog.spinner("show");
...
initDialog:function(){var a=this;a.zluxdialog=(new c.fn.zluxDialog({title:a.options.title,width:a.options.full_mode?"75%":300,dialogClass:"zl-bootstrap zlux-itemsmanager "+(a.options.full_mode?"zlux-dialog-full":"zlux-dialog-mini"),position:c.extend({of:a.dialogTrigger,my:"left top",at:"right bottom"},a.options.position)})).done(function(){a.zluxdialog.widget.attr("id","zluxItemsManager_"+a.ID);a.eventDialogLoaded()})},eventDialogLoaded:function(){var a=this;a.itemsmanager=c('<div class="zlux-itemsmanager" />').appendTo(a.zluxdialog.content);
...
e;c(".btn-group[data-id=2]",b).attr("data-update",!1)},function(){a.filter.types=""}),a.getSelect("aaCategories","Filter by Category",function(b){a.filter.cats=b},function(){a.filter.cats=""}),a.getSelect("aaTags","Filter by Tag",function(b){a.filter.tags=b},function(){a.filter.tags=""}));c(".dataTables_filter",a.oTable.fnSettings().nTableWrapper).appendTo(b);a.zluxdialog.initContent()});a.bind("ItemSelected",function(a,c,d){d.siblings("[data-checked]").removeAttr("data-checked");input.val(c).trigger("change")});
a.bind("ItemUnselected",function(){input.val("").trigger("change")})},getSelect:function(a,b,d,f){var g=this,j=c.parseJSON(g.oTable.fnSettings().jqXHR.responseText)[a],h=c('<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">'+b+'<span class="caret" /></a>'),k=c('<ul class="dropdown-menu">'+g._getSelectOptions(j)+"</ul>"),l=c('<div class="btn-group" data-text="'+b+'" />').append(h,k),m=c('<i class="icon-remove zlux-ui-dropdown-unselect" />').on("click",function(){h.html(b+'<span class="caret"></span>');
m.hide();c.isFunction(f)&&f();g.reload()}).hide().prependTo(l);j.length||h.addClass("disabled");h.on("click",function(){if(h.hasClass("disabled"))return!1});k.on("click","a",function(a){var f=c(this).data("value")?c(this).data("value"):"",j=b,j=c(this).text().replace(/^[^a-zA-Z]+/g,"").replace(/[^a-zA-Z]+$/g,"");m.show();h.html(j+'<span class="caret"></span>').data("selected-value",f);c.isFunction(d)&&d(f);g.reload();a.preventDefault()});g.bind("TableDrawCallback",function(){var d=c.parseJSON(g.oTable.fnSettings().jqXHR.responseText)[a];
k.empty().append(g._getSelectOptions(d));d.length||l.addClass("disabled");var e=!1;c.each(d,function(a,b){b.id==h.data("selected-value")&&(e=!0)});e||(m.hide(),h.data("selected-value","").html(b+'<span class="caret"></span>'))});return l},_getSelectOptions:function(a){var b,c=a.length,d=[];for(b=0;b<c;b++){var g='<li><a href="#" data-value="'+a[b].id+'">'+a[b].name+"</a></li>";-1<jQuery.inArray(g,d)||d.push(g)}return d.join("")}});c.fn[d.prototype.name]=function(){var a=arguments,b=a[0]?a[0]:null;
return this.each(function(){var e=c(this);if(d.prototype[b]&&e.data(d.prototype.name)&&"initialize"!=b)e.data(d.prototype.name)[b].apply(e.data(d.prototype.name),Array.prototype.slice.call(a,1));else if(!b||c.isPlainObject(b)){var f=new d;d.prototype.initialize&&f.initialize.apply(f,c.merge([e],a));e.data(d.prototype.name,f)}else c.error("Method "+b+" does not exist on jQuery."+d.name)})}})(jQuery);